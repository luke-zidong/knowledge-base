...
**更多命令参考 https://vuepress.mirror.docker-practice.com/compose/commands/#**
...
仅用于 `Swarm mode`，详细内容请查看 [`Swarm mode`](https://vuepress.mirror.docker-practice.com/swarm_mode/) 一节
...
**更多模板文件命令参考 https://vuepress.mirror.docker-practice.com/compose/compose_file/#**



# 参考

[Docker Compose 项目](https://vuepress.mirror.docker-practice.com/compose/)